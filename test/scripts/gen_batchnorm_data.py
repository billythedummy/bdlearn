...
bn.weight = weight
bn.bias = bias
test_tensor = tensor(in_data, dtype=torch.float32).reshape((n, c, h, w)).requires_grad_(True)
out = bn(test_tensor)
print(out.flatten())
print(bn.running_mean)
print(bn.running_var)
(2 * out.mean()).backward()
print(test_tensor.grad.flatten())
print(bn.weight.grad.flatten())
print(bn.bias.grad.flatten())