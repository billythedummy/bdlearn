#ifndef HALIDE___________include___schedules___libbatchcol2imaccum_h
#define HALIDE___________include___schedules___libbatchcol2imaccum_h
#include <stdint.h>
...
int libbatchcol2imaccum(struct halide_buffer_t *_in_buffer, int32_t _p, int32_t _s, int32_t _k, int32_t _out_width, int32_t _out_height, struct halide_buffer_t *_out_buffer) HALIDE_FUNCTION_ATTRS;
int libbatchcol2imaccum_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *libbatchcol2imaccum_metadata() HALIDE_FUNCTION_ATTRS;
