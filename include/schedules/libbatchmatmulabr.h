#ifndef HALIDE___________include___schedules___libbatchmatmulabr_h
#define HALIDE___________include___schedules___libbatchmatmulabr_h
#include <stdint.h>
...
int libbatchmatmulabr(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_out_buffer) HALIDE_FUNCTION_ATTRS;
int libbatchmatmulabr_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *libbatchmatmulabr_metadata() HALIDE_FUNCTION_ATTRS;
